...
const { runScheduler }     = require('./scheduler/index'); // ← ADDED
...
// // Update your session middleware to this:
// app.use(session({
//   secret           : process.env.SESSION_SECRET || 'dev-secret-change-in-prod',
//   resave           : false,
//   saveUninitialized: false,
...
//   // },
//   cookie: {
//   secure  : process.env.AZURE_ENV === 'production', // ← was: true
//   sameSite: process.env.AZURE_ENV === 'production' ? 'none' : 'lax', // ← was: 'none'
//   httpOnly: true,
